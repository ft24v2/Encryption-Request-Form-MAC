...
class Dialog(QtGui.QDialog):
    ...
    def SubmissionForm(self, text):
        ...
        outputform(ClientName, SUNet, Phone, Department, Duedateresponse, cryptform, datedueyo, loaneryesno, acyesno, NotesInput, serialresult)
    ...
    def SystemInformation(self):
        ...
        # Left Column Items
        hostnametext =QtGui.QLabel("Hostname: {}".format(hostname))
        global osresult
        osresult = osversion()
        ostextt = QtGui.QLabel("OS: {}".format(str(osresult)))

        global modelresult        
        modelresult = str(modelnumber())
        modeltext = QtGui.QLabel("Model Number: {}".format(modelresult))

        global serialresult
        serialresult = str(serialnumber())
    ...
    def TechForm(self):
        ...
        encryptionpathDropdown.addItem('Ready Mac'),           
        encryptionpathDropdown.addItem('New Mac'),           
        encryptionpathDropdown.addItem('Upgrade Mac'),            
        encryptionpathDropdown.addItem('Encrypted Mac'),
...
###############################################################################
    ...
    def onActivated(self, text):
        ...
        if text == 'Ready Mac':
            ...
            cryptform = 'New Mac'
        elif text == 'Upgrade Mac':
            cryptform = 'Upgrade Mac'
        elif text == 'Encrypted Mac':
            cryptform = 'Encrypted Mac'
        else:
            cryptform = 'Ready Mac'
